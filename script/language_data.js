languages = {
  en: {
    ...
    tnj_intro:
      'Traveling Nature Journals are the physical part of the Botanical Encounter project. They are on a mission to collect diverse stories of plant-human encounters. Starting their journeys from different places in the world and, with people\'s help, they travel to the Duchess-Anna-Amalia-Library in Weimar, Germany.<br /> They travel like plants, move on by being passed from one person to another or tagging along with travelers.<br />Please click a Traveling Nature Journal\'s image to see its travel route on the Map of Botanical Encounter. And if you would like to initiate a Traveling Nature Journal, please <a href="./initiate_a_traveling_nature_journal.html" target="blank"><b>check out the instruction</b></a>!',
    contact:
